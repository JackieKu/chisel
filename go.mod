module github.com/JackieKu/chisel

go 1.14

require (
	github.com/JackieKu/go-socks5 v0.0.0-20200217051412-a918588cbec7
	github.com/andrew-d/go-termutil v0.0.0-20150726205930-009166a695a2 // indirect
	github.com/fsnotify/fsnotify v1.4.7
	github.com/gorilla/websocket v1.4.0
	github.com/jpillora/ansi v0.0.0-20170202005112-f496b27cd669 // indirect
	github.com/jpillora/backoff v0.0.0-20180909062703-3050d21c67d7
	github.com/JackieKu/chisel v0.0.0-20200320072358-29b0ab4e88c6
